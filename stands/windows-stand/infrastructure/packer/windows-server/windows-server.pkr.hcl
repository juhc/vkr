# Packer конфигурация для создания шаблона Windows Server на Proxmox (UEFI/OVMF)
# Поддерживаемые версии: Windows Server 2016/2019/2022/2025 (зависит от вашего ISO)
