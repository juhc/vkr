...
### 📖 Основные документы для тестового развертывания:

1. **`infrastructure/terraform/proxmox/FIRST_RUN.md`** - **НАЧНИТЕ ОТСЮДА!**
   - Пошаговое руководство для первого запуска
   - Настройка Proxmox
   - Развертывание первой машины
   - Устранение проблем

2. **`infrastructure/terraform/proxmox/TESTING.md`**
   - Тестирование с ограниченными ресурсами
   - Примеры развертывания отдельных машин
   - Минимальные требования к ресурсам

3. **`infrastructure/terraform/proxmox/README.md`**
   - Общее руководство по развертыванию на Proxmox
...
# 2. Создайте шаблон Ubuntu 20.04
# Следуйте инструкциям в FIRST_RUN.md
```
...
cd scenarios/scenario-[name]/infrastructure/terraform/proxmox
...
enable_[machine1] = true
enable_[machine2] = false
enable_[machine3] = false

# Минимальные ресурсы для теста
[machine1]_cpu     = 1
[machine1]_memory  = 2048
[machine1]_disk_size = "20G"
```
...
1. **[Машина 1]** ([IP]) - минимальные ресурсы, простая конфигурация
2. **[Машина 2]** ([IP]) - минимальные ресурсы
3. **[Машина 3]** ([IP]) - для тестирования [тип уязвимостей]
...
| Машина | CPU | RAM | Диск |
|--------|-----|-----|------|
| [Машина 1] | 1 | 2 GB | 20 GB |
| [Машина 2] | 1 | 1 GB | 20 GB |
| [Машина 3] | 2 | 4 GB | 30 GB |
...
- **Подробное руководство**: `infrastructure/terraform/proxmox/FIRST_RUN.md`
- **Тестирование**: `infrastructure/terraform/proxmox/TESTING.md`
- **Настройка Proxmox**: `infrastructure/terraform/proxmox/PROXMOX_SETUP.md`
- **Общее руководство**: `infrastructure/terraform/proxmox/README.md`

---

**💡 Совет**: Начните с `FIRST_RUN.md` - там пошаговые инструкции для первого запуска!
