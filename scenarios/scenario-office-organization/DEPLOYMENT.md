# Руководство по развертыванию инфраструктуры офисной организации
...
- **Диск**: 200 GB свободного места (SSD рекомендуется)
...
cd vkr/scenarios/scenario-office-organization
```
...
Дождитесь полной загрузки всех виртуальных машин (обычно 2-5 минут).
...
ssh ubuntu@192.168.10.10  # Web server
ssh ubuntu@192.168.20.30  # Database server
```
