...
### 6. Billing Server (192.168.20.10)
...
### 10. Monitoring Server (192.168.30.10)
...
### 12. Backup Server (192.168.30.30)
...
### 13. Kali Linux Pentest Box (192.168.50.10)
...
- **Шлюз**: 192.168.50.1
- **DNS**: 8.8.8.8, 8.8.4.4
- **Доступ**: Доступ ко всем тестируемым сетям инфраструктуры
...
ping -c 4 192.168.10.30  # RADIUS сервер
...
# Брутфорс веб-формы
hydra -l admin -P /usr/share/wordlists/rockyou.txt http-post-form://192.168.20.40/login:username=^USER^&password=^PASS^:Invalid
```
...
- **Клиентская сеть** (10.0.0.0/8): Для тестирования PPPoE и DHCP серверов
- **Инфраструктурная сеть** (192.168.10.0/24): Для тестирования RADIUS, DNS, NTP
- **Сервисная сеть** (192.168.20.0/24): Для тестирования веб-приложений, биллинга, CRM
...
### Сценарий D: Атака через SNMP
1. Обнаружение слабых SNMP community strings
2. Получение информации о сетевом оборудовании
3. Модификация конфигурации оборудования
4. Перехват сетевого трафика
5. Компрометация всей инфраструктуры
