...
Сценарий упрощен для удобства обучения и содержит только **5 ключевых машин инфраструктуры**. Каждый сервер настроен с определенными уязвимостями и ошибками конфигурации для практического обучения.
...
### 2. Billing Server (192.168.20.10)
...
### 4. Monitoring Server (192.168.30.10)

#### Описание
Сервер мониторинга серверов и сервисов.
...
### 6. Kali Linux Pentest Box (192.168.50.10)
